...
[Projekte auf LabEx erkunden](https://labex.io/de/learn/git)

## Projekte

Entdecken Sie 3 anfängerfreundliche Git-Projekte und wenden Sie zentrale Konzepte in kleinen, vollständigen Programmen an. Jedes Projekt öffnet sich in LabEx mit einer einsatzbereiten Umgebung, damit Sie sich auf die Umsetzung konzentrieren können.

|   Index | Projekt                                                                                       | Schwierigkeit   | Übung                                                                          |
|---------|-----------------------------------------------------------------------------------------------|-----------------|--------------------------------------------------------------------------------|
|       1 | [Git für Anfänger](https://labex.io/de/courses/git-for-beginners)                             | Anfänger        | [Projekt starten](https://labex.io/de/courses/git-for-beginners)               |
|       2 | [GitHub Actions für Anfänger](https://labex.io/de/courses/github-actions-for-beginners)       | Anfänger        | [Projekt starten](https://labex.io/de/courses/github-actions-for-beginners)    |
|       3 | [Installation eines Git-Servers](https://labex.io/de/courses/project-installing-a-git-server) | Anfänger        | [Projekt starten](https://labex.io/de/courses/project-installing-a-git-server) |
