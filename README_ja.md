...
[LabEx でプロジェクトを見る](https://labex.io/ja/learn/git)

## プロジェクト

初心者向けの 3 個の Git プロジェクトで、言語の重要な概念を小さく完成したプログラムに変えて学べます。各プロジェクトは LabEx のすぐ使える環境で開くため、構築に集中できます。

|   インデックス | プロジェクト                                                                           | 難易度   | 練習                                                                       |
|----------|----------------------------------------------------------------------------------|-------|--------------------------------------------------------------------------|
|        1 | [初心者向け Git](https://labex.io/ja/courses/git-for-beginners)                       | 初級    | [プロジェクトを開始](https://labex.io/ja/courses/git-for-beginners)               |
|        2 | [初心者向け GitHub Actions](https://labex.io/ja/courses/github-actions-for-beginners) | 初級    | [プロジェクトを開始](https://labex.io/ja/courses/github-actions-for-beginners)    |
|        3 | [Git サーバーのインストール](https://labex.io/ja/courses/project-installing-a-git-server)   | 初級    | [プロジェクトを開始](https://labex.io/ja/courses/project-installing-a-git-server) |
