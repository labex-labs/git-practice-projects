...
[Explorar projetos no LabEx](https://labex.io/pt/learn/git)

## Projetos

Explore 3 projetos de Git para iniciantes e aplique conceitos essenciais em programas pequenos e completos. Cada projeto abre no LabEx com um ambiente pronto para uso, para que você possa se concentrar em criar.

|   Índice | Projeto                                                                                      | Dificuldade   | Prática                                                                        |
|----------|----------------------------------------------------------------------------------------------|---------------|--------------------------------------------------------------------------------|
|        1 | [Git para Iniciantes](https://labex.io/pt/courses/git-for-beginners)                         | Iniciante     | [Iniciar projeto](https://labex.io/pt/courses/git-for-beginners)               |
|        2 | [GitHub Actions para Iniciantes](https://labex.io/pt/courses/github-actions-for-beginners)   | Iniciante     | [Iniciar projeto](https://labex.io/pt/courses/github-actions-for-beginners)    |
|        3 | [Instalação de um Servidor Git](https://labex.io/pt/courses/project-installing-a-git-server) | Iniciante     | [Iniciar projeto](https://labex.io/pt/courses/project-installing-a-git-server) |
