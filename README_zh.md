...
[在 LabEx 浏览项目](https://labex.io/zh/learn/git)

## 项目

探索 3 个适合初学者的 Git 项目，将核心概念应用到小而完整的程序中。每个项目都会在 LabEx 中打开可直接使用的环境，让你专注于动手构建。

|   序号 | 项目                                                                              | 难度   | 练习                                                                  |
|------|---------------------------------------------------------------------------------|------|---------------------------------------------------------------------|
|    1 | [Git 入门指南](https://labex.io/zh/courses/git-for-beginners)                       | 初级   | [开始项目](https://labex.io/zh/courses/git-for-beginners)               |
|    2 | [GitHub Actions 入门指南](https://labex.io/zh/courses/github-actions-for-beginners) | 初级   | [开始项目](https://labex.io/zh/courses/github-actions-for-beginners)    |
|    3 | [安装 Git 服务器](https://labex.io/zh/courses/project-installing-a-git-server)       | 初级   | [开始项目](https://labex.io/zh/courses/project-installing-a-git-server) |
